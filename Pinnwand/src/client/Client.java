			...
			while(!stopped){	
			    ...
			    if (input.equals("quit")){
			    	...
			    	if(pinn.putMessage(msg)){
			    		System.out.println("Message erfolgreich hinzugefügt.");
			    	}else{
			    	...
			    	System.out.println("Bitte geben Sie das Passwort für den Server ein: ");
			    	...
			    	System.out.println();
			    	System.out.println("Mögliche Befehle: login, putMsg, getMessages, getSingleMsg, getNumberMsg ");
			    }else{
			    	System.out.println();
